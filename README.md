...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-tidyselect-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-tidyselect-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-tidyselect-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-tidyselect-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-tidyselect-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-tidyselect-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-tidyselect/badges/version.svg)](https://anaconda.org/conda-forge/r-tidyselect)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-tidyselect/badges/downloads.svg)](https://anaconda.org/conda-forge/r-tidyselect)
